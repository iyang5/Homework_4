...
```
The above illustrates that the paste0 function merges the strings **without a space in between.**
...
mySeparatedString_2 <- str_split(myNewString, "_")
mySeparatedString_2
...
myNewSplitSpring_2 <- str_split(myNewString, "_", n=2)
myNewSplitSpring_2
...
punModified_B <- stri_replace_all_fixed(pun, c("his", "he", "sher", "shead", "tshe"), c("her", "she", "her", "head", "the"), vectorize_all = FALSE)
punModified_B
